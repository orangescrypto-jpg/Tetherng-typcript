  ...
  return (
    <Routes>
      ...
      <Route element={<DashboardLayout />}>
        ...
        {/* Placeholder routes — will be built in next steps */}
      ...
      {/* Public listing page (no auth needed) */}
...
function PlaceholderPage({ title }: { title: string }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-surface-200 border border-surface-300">
